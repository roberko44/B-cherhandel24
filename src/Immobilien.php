...
class Immobilien extends Page
{
    ...
    {
        $this->_recordset = $this->_database->query("select * from buch where kategorieid = 4"); //SQL Anfrage
        if (!$this->_recordset) {
    ...
    protected function generateView()
    {
        ...
        echo <<<EOT
        <div id="headerDir">
        <span>Home > Kategorien > <b>Immobilien</b></span>   
        </div>
        </div>
